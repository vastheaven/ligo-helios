...
ADMINS = (
    ('guzi5618@gmail.com', 'guzi5618@gmail.com'),
...
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL','ligo.helios@gmail.com')
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'LIGO Helios')
...
URL_HOST = get_from_env("URL_HOST", "http://golf.astro.cf.ac.uk:8000")

# IMPORTANT: you should not change this setting once you've created
# elections, as your elections' cast_url will then be incorrect.
# SECURE_URL_HOST = "https://localhost:8443"
SECURE_URL_HOST = get_from_env("SECURE_URL_HOST", "http://golf.astro.cf.ac.uk:8000")
...
# page. Not cool.
SOCIALBUTTONS_URL_HOST=get_from_env("SOCIALBUTTONS_URL_HOST", "http://golf.astro.cf.ac.uk:8000")

# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'LIGO Election System')

# FOOTER links
FOOTER_LINKS = []
FOOTER_LOGO = False

WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "Welcome.")

HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'hao.liu@ligo.org')
...
AUTH_ENABLED_AUTH_SYSTEMS = ['password', 'google', 'shib']
...
EMAIL_HOST_USER = 'ligo.helios@gmail.com'
EMAIL_HOST_PASSWORD = 'ligohelioshaoliu'
EMAIL_PORT = 587
